...
%DXC% -Zpr -O3 -auto-binding-space 0 -Wno-parentheses-equality -disable-lifetime-markers -T vs_6_6 -E Main -Fc LumenCardVertexShader.d3dasm -Fo LumenCardVertexShader.dxil LumenCardVertexShader
:END
PAUSE
